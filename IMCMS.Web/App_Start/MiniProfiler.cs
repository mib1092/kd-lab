...
[assembly: WebActivatorEx.PreApplicationStartMethod(
    typeof(IMCMS.Web.App_Start.MiniProfilerPackage), "PreStart")]

[assembly: WebActivatorEx.PostApplicationStartMethod(
    typeof(IMCMS.Web.App_Start.MiniProfilerPackage), "PostStart")]
...
namespace IMCMS.Web.App_Start
{
    public static class MiniProfilerPackage
    {
        ...
        public static void PostStart()
        {
            ...
            ignored.Add("includes");
            ignored.Add("images");
            ignored.Add("cassette.axd");
            ignored.Add("assets");
			ignored.Add("bundles");
    ...
    public class MiniProfilerStartupModule : IHttpModule
    {
        public void Init(HttpApplication context)
        {
            ...
            {
                if (!context.Request.IsLocal) { StackExchange.Profiling.MiniProfiler.Stop(discardResults: true); }
            };
